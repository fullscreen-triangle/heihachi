  ...
  return (
    ...
    ">
      ...
      <nav className="flex items-center justify-center">
        ...
        <CustomLink className="mx-4" href="/player" title="Player" />
        <CustomLink className="mx-4" href="/api-docs" title="API" />
        <CustomLink className="ml-4" href="/investors" title="Investors" />
      </nav>
      ...
      </div>
    {
      ...
      <nav className="flex items-center justify-center flex-col">
        ...
        <CustomMobileLink toggle={handleClick} className="lg:m-0 lg:my-2" href="/framework" title="Framework" />
        <CustomMobileLink toggle={handleClick} className="lg:m-0 lg:my-2" href="/research" title="Research" />
        <CustomMobileLink toggle={handleClick} className="lg:m-0 lg:my-2" href="/player" title="Player" />
        <CustomMobileLink toggle={handleClick} className="lg:m-0 lg:my-2" href="/api-docs" title="API" />
        <CustomMobileLink toggle={handleClick} className="lg:m-0 lg:my-2" href="/investors" title="Investors" />
      </nav>
