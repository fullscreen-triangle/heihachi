...
class MixVisualizer:
    ...
    def plot_mix_heatmap(self, metrics: Dict, times: List[float],
                         output_path: str = "mix_heatmap.png"):
    ...
    def plot_mix_radar(self, metrics: Dict, timestamps: List[float],
                       output_path: str = "mix_radar.html"):
    ...
    def create_summary_report(self, results: Dict, output_path: str = "summary.html"):
...
class AnalysisVisualizer:
    ...
    def plot_amen_break_analysis(self, audio: np.ndarray, results: Dict, 
        ...
        fig = make_subplots(
            ...
            specs=[[{"type": "xy"}, {"type": "xy"}, {"type": "polar"}] for _ in range(n_segments)],
